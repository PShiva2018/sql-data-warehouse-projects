...
SQL Server Express – Lightweight SQL Server edition.
SQL Server Management Studio (SSMS) – GUI for managing and interacting with databases.
GitHub – Manage, version, and collaborate on your code.
DrawIO – Design data architecture, models, and diagrams.
Notion – All-in-one tool for project management and documentation.
